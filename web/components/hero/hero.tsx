  ...
  return (
    <section className="relative pt-12 sm:pt-16 pb-20 sm:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        {/* LEFT COLUMN (Cols 1-6): Clean Editorial Typography & CTAs (Exact Proven Standard) */}
        <div className="lg:col-span-6 space-y-8 max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter text-white leading-[0.93] uppercase select-none">
            DECONSTRUCT <br />
            MOTORSPORT <br />
        ...
        {/* RIGHT COLUMN (Cols 7-12): Seamless Shadow Machine Silhouette (NO BOXES, NO BORDERS) */}
        <div className="lg:col-span-6 relative w-full h-[380px] sm:h-[460px] flex items-center justify-center select-none pointer-events-none">
          ...
          {/* Soft Asphalt Tire Reflection */}
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-4/5 h-8 bg-[#D2FF00]/10 rounded-full blur-2xl" />
          ...
          <div
            ...
            style={{
              maskImage: "radial-gradient(ellipse 85% 70% at 55% 50%, black 40%, transparent 100%)",
              WebkitMaskImage: "radial-gradient(ellipse 85% 70% at 55% 50%, black 40%, transparent 100%)"
            }}
          >
            <Image
              ...
              className="object-contain object-center scale-105 brightness-90 contrast-125 filter drop-shadow-[0_25px_35px_rgba(0,0,0,0.95)]"
            />
          </div>

          {/* Technical Registration Datums (Micro CAD Crosshair Markers) */}
          {/* Datum 1: Active Swan-Neck Rear Wing */}
          <div className="absolute top-[22%] right-[12%] flex items-center gap-1.5 font-mono text-[9px] text-slate-400 bg-[#070A10]/80 backdrop-blur px-2 py-0.5 rounded border border-white/10 shadow-lg">
            <span className="text-[#D2FF00] font-bold">⌖</span>
            <span>AERO_DATUM: X:1420.0 Y:884.5</span>
          </div>

          {/* Datum 2: Carbon Monocoque Core Hub */}
          <div className="absolute bottom-[24%] right-[42%] flex items-center gap-1.5 font-mono text-[9px] text-slate-400 bg-[#070A10]/80 backdrop-blur px-2 py-0.5 rounded border border-white/10 shadow-lg">
            <span className="text-cyan-400 font-bold">⌖</span>
            <span>HUB_AXLE: Z:285.0 MM</span>
          </div>

          {/* Datum 3: Front Splitter Stagnation Point */}
          <div className="absolute bottom-[32%] left-[8%] flex items-center gap-1.5 font-mono text-[9px] text-slate-400 bg-[#070A10]/80 backdrop-blur px-2 py-0.5 rounded border border-white/10 shadow-lg">
